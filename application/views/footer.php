        ...
        <div class="row">
            ...
            <div class="mt-4 col-sm-6 col-md-4 col-lg-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-2"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i>&nbsp;<span class="d-md-none d-lg-none">@stt_adisutjipto</span></div>
                    <div class="col-md-2 col-lg-2"><i class="fa fa-youtube-play fa-2x" aria-hidden="true"></i>&nbsp;<span class="d-md-none d-lg-none">STT Adisutjipto</span> </div>
                </div>
            </div>
        </div>
