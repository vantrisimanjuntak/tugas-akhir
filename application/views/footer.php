    ...
    <div class="pt-4">
        <div class="container">
            <div class="row">
                ...
                <div class="mt-3 col-sm-6 col-md-5 col-lg-4">
                    <h4 class="display-5 align-middle" style="font-family: 'Lora', serif;">Sekolah Tinggi Teknologi Adisutjipto</h4>
                ...
                <div class="mt-3 col-sm-6 col-md-4 col-lg-2">
                    ...
                    <div class="row">
                        <div class="ml-2 col-xs-1 col-sm-1">
